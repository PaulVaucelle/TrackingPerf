...
#$$
      ...
      tracks                   = cms.untracked.InputTag('generalTracks'),#'generalTracks'ou 'packedPFCandidates'
      trackLabel               = cms.InputTag('generalTracks'),#not used,'generalTracks'ou 'packedPFCandidates'
