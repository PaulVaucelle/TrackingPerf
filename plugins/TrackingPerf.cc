      ...
      if ( pdgid >= 1 && pdgid <= 6 ) {
        ...
        if ( abs(mom->pdgId()) == 1000023 ) { 
          ...
          if ( nllp == 1 ) {
            ...
            if ( dV > 0.01 ) {//may be a bug here on the computation of dV
              nllp = 2;
...
//$$
  ...
  vector<reco::TransientTrack> Tracks_Hemi_llp1, Tracks_Hemi_llp2, displacedTracks_Hemi_mva_llp1, displacedTracks_Hemi_mva_llp2;//Tracks selected wrt the hemisphere
  ...
  if ( showlog ) {
    ...
    cout << " displaced tracks Hemi LLP1 " << Tracks_Hemi_llp1.size() << " and with mva" << displacedTracks_Hemi_mva_llp1.size() << endl;
    cout << " displaced tracks Hemi LLP2 " << Tracks_Hemi_llp2.size() << " and with mva" << displacedTracks_Hemi_mva_llp2.size() << endl;
  }
...
//--------------------------- FIRST LLP WITH HEMISPHERE-------------------------------------//
  ...
  if ( Vtx_ntk > 1 )
  {
    TransientVertex displacedVertex_Hemi_llp1 = theFitter_vertex_Hemi_llp1.vertex(Tracks_Hemi_llp1); // fitted vertex
  ...
  tree_Vtx_Hemi_LLP1_nTrks = Vtx_ntk;        
  tree_Vtx_Hemi_LLP1_x = Vtx_x;
  tree_Vtx_Hemi_LLP1_y = Vtx_y;
  tree_Vtx_Hemi_LLP1_z = Vtx_z;
  tree_Vtx_Hemi_LLP1_NChi2 = Vtx_chi;
...
//--------------------------- SECOND LLP WITH HEMISPHERE-------------------------------------//
  ...
  if ( Vtx_ntk > 1 )
  {
    TransientVertex displacedVertex_Hemi_llp2 = theFitter_vertex_Hemi_llp2.vertex(Tracks_Hemi_llp2); // fitted vertex
  ...
  tree_Vtx_Hemi_LLP2_nTrks = Vtx_ntk;        
  tree_Vtx_Hemi_LLP2_x = Vtx_x;
  tree_Vtx_Hemi_LLP2_y = Vtx_y;
  tree_Vtx_Hemi_LLP2_z = Vtx_z;
  tree_Vtx_Hemi_LLP2_NChi2 = Vtx_chi;
...
//--------------------------- FIRST LLP WITH HEMISPHERE WITH MVA-------------------------------------//
  ...
  tree_Vtx_Hemi_mva_LLP1_nTrks = Vtx_ntk;        
  tree_Vtx_Hemi_mva_LLP1_x = Vtx_x;
  tree_Vtx_Hemi_mva_LLP1_y = Vtx_y;
  tree_Vtx_Hemi_mva_LLP1_z = Vtx_z;
  tree_Vtx_Hemi_mva_LLP1_NChi2 = Vtx_chi;
...
//--------------------------- SECOND LLP WITH HEMISPHERE WITH MVA-------------------------------------//
  ...
  tree_Vtx_Hemi_mva_LLP2_nTrks = Vtx_ntk;        
  tree_Vtx_Hemi_mva_LLP2_x = Vtx_x;
  tree_Vtx_Hemi_mva_LLP2_y = Vtx_y;
  tree_Vtx_Hemi_mva_LLP2_z = Vtx_z;
  tree_Vtx_Hemi_mva_LLP2_NChi2 = Vtx_chi;
